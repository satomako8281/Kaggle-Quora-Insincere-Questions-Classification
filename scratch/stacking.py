...
va_preds = []
te_preds = []
va_preds.append(joblib.load("valid_pred_tfidf.pkl").T)
va_preds.append(joblib.load("valid_pred_mercari.pkl").T)
va_preds.append(joblib.load("valid_pred_bilstm.pkl").T)
va_preds.append(joblib.load("valid_pred_pytorch.pkl").T)
te_preds.append(joblib.load("test_pred_tfidf.pkl").T)
te_preds.append(joblib.load("test_pred_mercari.pkl").T)
te_preds.append(joblib.load("test_pred_bilstm.pkl").T)
te_preds.append(joblib.load("test_pred_pytorch.pkl").T)

...
lb_te_preds.append(joblib.load("lb_test_pred_tfidf.pkl")[:, np.newaxis])
# lb_te_preds.append(joblib.load("lb_test_pred_mercari.pkl")[:, np.newaxis])
lb_te_preds.append(joblib.load("lb_test_pred_bilstm_0.pkl")[:, np.newaxis])
lb_te_preds.append(joblib.load("lb_test_pred_bilstm_1.pkl")[:, np.newaxis])
lb_te_preds.append(joblib.load("lb_test_pred_pytorch_0.pkl")[:, np.newaxis])
lb_te_preds.append(joblib.load("lb_test_pred_pytorch_1.pkl")[:, np.newaxis])
va_preds = np.hstack(va_preds)

print(lb_te_preds[0].shape)
print(lb_te_preds[1].shape)
print(lb_te_preds[2].shape)
# print(te_preds[3].shape
...
# delta1, f_score = bestThresshold(y_te, te_preds_merged)
f_score = f1_score(y_te, te_preds_merged > delta)

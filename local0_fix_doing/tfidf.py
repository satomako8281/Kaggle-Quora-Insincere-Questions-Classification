...
with timer("getting ngram tfidf"):
    ...
    X_lb_test = tfidf_vectorizer.transform(lb_test['question_text'])
...
with timer("get Naive Bayes feature"):
    ...
    X_lb_test_nb = nb_transformer.transform(X_lb_test)
...
lb_test_meta += model.predict_proba(X_lb_test_nb)[:,1] / 1
joblib.dump(test_meta, 'test_pred_tfidf.pkl', compress=3)
joblib.dump(lb_test_meta, 'lb_test_pred_tfidf.pkl', compress=3)
